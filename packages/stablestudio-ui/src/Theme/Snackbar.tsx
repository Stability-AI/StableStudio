...
>(({ id, message, persist, Icon }, ref) => {
  ...
  return (
    <div
      className="mb-4 flex items-center rounded-lg border border-zinc-300 bg-white p-3 text-zinc-500 shadow dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-400"
      role="alert"
      ref={ref}
    >
      {Icon}
